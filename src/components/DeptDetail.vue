    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6">
          ...
          <p
            style="font-size: 20px"
            v-if="detail[0] && detail[0].written_exam_weight !== '0.00'"
          >
            有
          </p>
        ...
        <div class="col-lg-4 col-md-6">
          ...
          <p
            style="font-size: 20px"
            v-if="detail[0] && detail[0].interview_weight !== '0.00'"
          >
            有
          </p>
          <p style="font-size: 20px" v-else>無</p>
        ...
        <div class="col-lg-4 col-md-6">
          ...
          <p
            style="font-size: 20px"
            v-if="detail[0] && detail[0].review_weight !== '0.00'"
          >
            有
          </p>
          <p style="font-size: 20px" v-else>無</p>
